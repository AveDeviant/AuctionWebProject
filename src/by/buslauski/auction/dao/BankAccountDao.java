...
public class BankAccountDao extends AbstractDao {
    ...
    public BankAccountDao(ProxyConnection connection) {
        super(connection);
    }
    ...
    private BankCard initBankCard(ResultSet resultSet) throws SQLException {
        ...
        bankCard.setCardId(Long.parseLong(resultSet.getString("id_account")));
        bankCard.setUserId(Long.parseLong(resultSet.getString("id_user")));
