...
public class UserDao extends AbstractDao {
    ...
    private static final String SQL_SELECT_ALL_USERS = "SELECT id_user, user.id_role, name, username, email, password, city, address, phone_number, access, real_name " +
            "FROM user JOIN role ON user.id_role=role.id_role WHERE name='customer'";
    ...
    public void addUser(int id_role, String userName, String email, String password, int access) throws DAOException {
