...
public class OrderDao extends AbstractDao {
    private static final String SQL_SELECT_ALL_ORDERS = "SELECT id_order, order.id_user, id_lot, payment, date, accept," +
            " real_name, city, address, phone_number FROM auction.order JOIN user ON order.id_user=user.id_user";
    ...
    public void createOrder(long customerId, long lotId, BigDecimal price) throws DAOException {
